...
import { z } from 'zod';
import { rolesApi, type ManagedRole } from './roles';
...
export function RolesPage() {
  ...
  const togglePermission = (id: string, checked: boolean) => {
    const selected = form.getValues('permissionIds');
    form.setValue('permissionIds', checked ? [...selected, id] : selected.filter((value) => value !== id), { shouldDirty: true });
  };
